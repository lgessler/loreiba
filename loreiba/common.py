...
# from AllenNLP https://github.com/allenai/allennlp/blob/main/allennlp/nn/util.py
def batched_span_select(target: torch.Tensor, spans: torch.LongTensor) -> Tuple[torch.Tensor, torch.Tensor]:
    """
...
# Adapted from https://github.com/allenai/allennlp/blob/main/allennlp/modules/token_embedders/pretrained_transformer_mismatched_embedder.py#L103L176
def pool_embeddings(
    embeddings: torch.Tensor,
    offsets: torch.LongTensor,
    pooling_strategy: Literal["avg"] = "avg",
) -> torch.Tensor:  # type: ignore
    """
    # Parameters
    embeddings: `torch.Tensor`
        Shape: [batch_size, num_wordpieces, embedding_dim]
    offsets: `torch.LongTensor`
    ...
    raise ValueError(f"Unknown strategy: {pooling_strategy}")
