"""
This contains a slightly modified form of info-nce-pytorch==0.1.4 (https://github.com/RElbers/info-nce-pytorch)
"""
import torch
...
def info_nce(
    query, positive_key, negative_keys=None, temperature=0.1, reduction="mean", negative_mode="unpaired", top_k=None
):
